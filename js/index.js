...
{   
    ...
    {
        $("#sidebar").animate ( {left: "-190px"} ,800);
    ...
    else //wana open it
    {
        ...
        $(".nav-header").animate ( {left: "190px"} ,1000);
...
async function myData(term)
{
    
    let apiData = await fetch(`https://api.themoviedb.org/3/${term}/movie/week?api_key=f1aca93e54807386df3f6972a5c33b50`)
    let final = await apiData.json();
    myMovies = final.results
    console.log(myMovies)
    displayMovies()
}
myData("trending");//Trending// Popular//Top Rated
